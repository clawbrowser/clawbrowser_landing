        ...
        <div className="flex items-center justify-between gap-4 px-4 py-3 sm:px-6 sm:py-3.5">
          ...
          <div className="flex items-center gap-2">
            <a
              ...
              title="GitHub"
              className="hidden sm:inline-flex h-9 w-9 items-center justify-center rounded-lg text-zinc-600 transition-colors hover:bg-zinc-100 hover:text-zinc-950 dark:text-slate-300 dark:hover:bg-slate-800 dark:hover:text-white"
            >
