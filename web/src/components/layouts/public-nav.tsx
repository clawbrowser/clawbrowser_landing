          ...
          <div className="flex items-center gap-2">
            <div className="hidden sm:flex items-center gap-1">
              <a
                ...
                aria-label="Clawbrowser on GitHub"
                title="GitHub"
                className="inline-flex h-9 w-9 items-center justify-center rounded-lg text-zinc-600 transition-colors hover:bg-zinc-100 hover:text-zinc-950 dark:text-slate-300 dark:hover:bg-slate-800 dark:hover:text-white"
              >
              ...
              <span className="text-sm font-medium text-zinc-700 dark:text-zinc-200">5</span>
            </div>
            <a
