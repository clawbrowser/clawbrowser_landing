...
export const metadata: Metadata = {
  ...
  description:
    "See how teams use Clawbrowser for web scraping, multi-account management, AI agent automation, market monitoring, and sales prospecting.",
          ...
          {USE_CASES.map((uc) => (
            ...
            >
              ...
              <div className="flex flex-1 flex-col gap-2">
                ...
                <p className="text-sm leading-relaxed text-zinc-500 dark:text-zinc-400">{uc.description}</p>
              </div>
