...
export const metadata: Metadata = {
  ...
  description: "Chromium fork with managed fingerprints and transparent proxy routing. Stop fighting captchas and bot detection. Works with Playwright, Puppeteer, and any CDP tool.",
