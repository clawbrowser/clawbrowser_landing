...
export default function NotFound() {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center px-6 text-center bg-[#FAFAF8] dark:bg-[#0c0c0e]">
      {/* GitHub Pages serves this for any unknown path, so send people back home immediately. */}
      <script dangerouslySetInnerHTML={{ __html: `(function(){location.replace("/");})();` }} />
      ...
      <p className="text-zinc-500 dark:text-zinc-400 mb-8 max-w-sm">
        The page you&apos;re looking for doesn&apos;t exist or has been moved. Redirecting you to the homepage.
      </p>
      <Link
        href="/"
